...
WORKFLOW_SPEC = ROOT / "workflow/specification.md"
QUALITY_GATES = ROOT / "config/quality_gates.toml"
MEMORY_PROTOCOL = ROOT / "workflow/memory-protocol.md"
MEMORY_PATH = ROOT / "memory/MEMORY.md"
SESSION_LOG = ROOT / "memory/session-log.md"
DECISIONS_INDEX = ROOT / "decisions/INDEX.md"
PACKET_TEMPLATE = ROOT / "prompts/code-audit.md"
REPORT_TEMPLATE = ROOT / "templates/code-review-report.md"
AUDITS_DIR = ROOT / "workspace/audits"

AGENT_BY_LANGUAGE = {
    "python": ROOT / "agents/python-reviewer.md",
    "stata": ROOT / "agents/stata-reviewer.md",
    "r": ROOT / "agents/r-reviewer.md",
}
