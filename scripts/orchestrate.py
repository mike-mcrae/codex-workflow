...
QUALITY_PATH = ROOT / "config/quality_gates.toml"
WORKFLOW_SPEC_PATH = ROOT / "workflow/specification.md"
MEMORY_PROTOCOL_PATH = ROOT / "workflow/memory-protocol.md"
MEMORY_PATH = ROOT / "memory/MEMORY.md"
MEMORY_TOPICS_PATH = ROOT / "memory/topics/README.md"
SESSION_LOG_PATH = ROOT / "memory/session-log.md"
DECISIONS_INDEX_PATH = ROOT / "decisions/INDEX.md"
PROJECT_BRIEF_PATH = ROOT / "workspace/input/project-brief.md"
SOURCE_NOTES_PATH = ROOT / "workspace/input/source-notes.md"
RUNS_DIR = ROOT / "workspace/runs"

STAGE_TO_TEMPLATE = {
    "planning": ROOT / "templates/plan.md",
    "writing": ROOT / "templates/draft.md",
    "review": ROOT / "templates/review-report.md",
    "refinement": ROOT / "templates/revision-log.md",
}

STAGE_TO_PROMPT = {
    "planning": ROOT / "prompts/planner.md",
    "writing": ROOT / "prompts/writer.md",
    "review": ROOT / "prompts/reviewer.md",
    "refinement": ROOT / "prompts/refiner.md",
}

AGENT_PATHS = {
    "planner": ROOT / "agents/planner.md",
    "writer": ROOT / "agents/writer.md",
    "reviewer": ROOT / "agents/reviewer.md",
    "methods-referee": ROOT / "agents/methods-referee.md",
    "adversarial-reviewer": ROOT / "agents/adversarial-reviewer.md",
    "final-editor": ROOT / "agents/final-editor.md",
}
