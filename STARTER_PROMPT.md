...
1. Read README.md, SETUP.md, workflow/specification.md, workflow/memory-protocol.md, config/project.toml, workspace/input/project-brief.md, workspace/input/source-notes.md, memory/MEMORY.md, and memory/session-log.md.
...
3. Use the layered memory model correctly:
   ...
   - Layer 4: transcripts/*
4. Do not draft the paper immediately. Start with planning.
